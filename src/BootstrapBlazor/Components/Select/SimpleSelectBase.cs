...
public abstract class SimpleSelectBase<TValue> : SelectBase<TValue>
{
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 选项数据加载方法</para>
    /// <para lang="en">Gets or sets Option Query Method</para>
    /// </summary>
    [Parameter]
    public Func<Task<List<SelectedItem>?>>? OnQueryItemsAsync { get; set; }

    /// <summary>
    /// <para lang="zh">获得/设置 是否显示加载状态</para>
    /// <para lang="en">Gets or sets whether to show loading state</para>
    /// </summary>
    protected bool ShowLoading { get; set; }

    /// <summary>
    /// <para lang="zh">点击时加载数据方法</para>
    /// <para lang="en">Loads data when clicking</para>
    /// </summary>
    protected async Task OnInternalClickAsync()
    {
